...
case MSP_NAME:
    ...
    case MSP_GPS_RESCUE:
        sbufWriteU16(dst, autopilotConfig()->max_angle);
    ...
    case MSP_GPS_RESCUE_PIDS:
        ...
        sbufWriteU16(dst, autopilotConfig()->position_P);
        sbufWriteU16(dst, autopilotConfig()->altitude_I);
        sbufWriteU16(dst, autopilotConfig()->altitude_D);
...
static mspResult_e mspProcessInCommand(mspDescriptor_t srcDesc, int16_t cmdMSP, sbuf_t *src)
{
    ...
    case MSP_SET_GPS_RESCUE:
        autopilotConfigMutable()->max_angle = sbufReadU16(src);
    ...
    case MSP_SET_GPS_RESCUE_PIDS:
        ...
        autopilotConfigMutable()->position_P = sbufReadU16(src);
        autopilotConfigMutable()->position_I = sbufReadU16(src);
        autopilotConfigMutable()->position_D = sbufReadU16(src);
