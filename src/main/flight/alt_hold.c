...
{
    // Vertical velocity
    // boost by 'increasing apparent velocity' when vertical velocity exceeds 5 m/s ( D of 75 on defaults)
    ...
    // A commanded drop at 100cm/s will return feedforward of the user's F value. or 15 on defaults
