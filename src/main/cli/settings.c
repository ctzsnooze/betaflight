...
// PG_GPS_CONFIG
    ...
    { PARAM_NAME_ALT_HOLD_THROTTLE_RATE, VAR_UINT8 | MASTER_VALUE, .config.minmaxUnsigned = { 0, 200 }, PG_ALTHOLD_CONFIG, offsetof(altHoldConfig_t, alt_hold_throttle_rate) },
